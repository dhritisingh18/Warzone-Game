 ...
 * @version 1.0.0
 */
public class Reinforcement implements GameHandler {
    /**
     ...
     */
    public GameCycle start(GameCycle currentGamePhase) throws ValidationFailure, InvalidExecutionFailure {
    ...
    @Override
    public GameCycle begin(GameCycle p_GamePhase) throws Exception {
        return null;
    }
}
